...
parser.add_argument('--filter_method', type=str, default='o3d', choices=["o3d", "normal"], help="filter method")
...
def check_geometric_consistency(depth_ref, intrinsics_ref, extrinsics_ref, depth_src, intrinsics_src, extrinsics_src):
    ...
    # mask = np.logical_and(dist < 0.5, relative_depth_diff < 0.001)
    mask = np.logical_and(dist < 0.25, relative_depth_diff < 0.001)
...
if __name__ == '__main__':
    ...
    if args.dataset.startswith('general'):
        ...
        if args.filter_method == "o3d":
            open3d_filter(data_list=args.testlist,
                          root_path=args.outdir,
                          depth_path=args.outdir,
                          ply_path=os.path.join(args.outdir, "ply"),
                          prob_thresh=0.03,
                          dist_thresh=0.2,
                          num_consist=2)
        else:

...
s_all = {'Family': 2, 'Francis': 4, 'Horse': 2, 'Lighthouse': 3, 'M60': 2, 'Panther': 2, 'Playground': 3, 'Train': 3}
conf_all = {'Family': 0.3, 'Francis': 0.4, 'Horse': 0.1, 'Lighthouse': 0.75, 'M60': 0.3, 'Panther': 0.3,
            'Playground': 0.4, 'Train': 0.4}
dist_all = {'Family': 1 / 8, 'Francis': 1 / 4, 'Horse': 1 / 2, 'Lighthouse': 1 / 4, 'M60': 1 / 4, 'Panther': 1 / 4,
            'Playground': 1 / 4, 'Train': 1 / 4}
rel_diff_all = {'Family': 1 / 1500, 'Francis': 1 / 1500, 'Horse': 1 / 1000, 'Lighthouse': 1 / 1000, 'M60': 1 / 1600,
                'Panther': 1 / 1500, 'Playground': 1 / 1600, 'Train': 1 / 1600}
...
parser.add_argument('--testlist', default='lists/tnt/inter.txt', help='testing scene list')

parser.add_argument('--batch_size', type=int, default=1, help='testing batch size')
parser.add_argument('--loadckpt', default=None, help='load a specific checkpoint')
parser.add_argument('--outdir', default='/media/data2/RRT_resule/tnt/RRT_b2_d6_2/n21', help='output dir')
...
parser.add_argument('--max_h', type=int, default=896, help='testing max h')
parser.add_argument('--max_w', type=int, default=1216, help='testing max w')
...
parser.add_argument('--image_size', type=str, default=None, help='training image size, will be set dynamically')
...
def save_scene_depth(testlist):
    ...
    if args.dataset == 'tanks' or args.dataset == 'tanks_long':
        ...
        # If image_size is a string, convert it to a tuple of ints
        if isinstance(args.image_size, str):
            args.image_size = tuple(map(int, args.image_size.strip('()').split(',')))
        ...
        for batch_idx, sample in enumerate(TestImgLoader):
            ...
            for filename, cam, img, depth_est, photometric_confidence in zip(filenames, cams, imgs, \
                ...
                if scan == 'Lighthouse':
                    ...
                    photometric_confidence = confidence_list[0] * confidence_list[1] * confidence_list[2] * \
                                             confidence_list[3]

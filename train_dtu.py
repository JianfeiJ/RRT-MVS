...
parser.add_argument('--image_size', type=str, default=(512, 640), help='training image size')
...
parser.add_argument('--reg_mode', type=str, default="reg2d_hybrid", choices=['reg2d', 'reg3d',
                                                                           'reg2d_hybrid', 'reg3d_hybrid'])
        ...
        for batch_idx, sample in enumerate(TrainImgLoader):
            ...
            if (not is_distributed) or (dist.get_rank() == 0):
                if do_summary:
                    ...
                    print(
                       "Epoch {}/{}, Iter {}/{}, lr {:.6f}, train loss = {:.3f}, ce_loss = {:.3f}, {:.3f}, {:.3f}, {:.3f}, range_err = {:.3f}, {:.3f}, {:.3f}, {:.3f}, time = {:.3f}".format(
            ...
            for batch_idx, sample in enumerate(TestImgLoader):
                ...
                if (not is_distributed) or (dist.get_rank() == 0):
                    if do_summary:
                        ...
                        print(
                            "Epoch {}/{}, Iter {}/{}, lr {:.6f}, test loss = {:.3f}, ce_loss = {:.3f}, {:.3f}, {:.3f}, {:.3f}, range_err = {:.3f}, {:.3f}, {:.3f}, {:.3f}, time = {:.3f}".format(
...
def train_sample(model, model_loss, optimizer, sample, args):
    ...
    loss, stage_ce_loss, range_err_ratio = model_loss(
...
if __name__ == '__main__':
    ...
    if args.dataset.startswith('dtu'):
        ...
        test_dataset = MVSDataset(args.testpath, args.testlist, "val", 5, args.interval_scale, use_raw_train=args.use_raw_train)
